...
const Testimonials: React.FC = () => {
  ...
  return (
    <div className="relative">
      <div className="absolute top-0 left-0 right-0 h-32 bg-gradient-to-b from-white to-gray-50"></div>
      <div id="testimonials" className="bg-gray-50 section-padding pt-32 relative z-10">
