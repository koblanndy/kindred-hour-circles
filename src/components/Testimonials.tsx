    ...
    <div id="testimonials" className="bg-gray-50 section-padding">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-8 md:mb-16">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 text-gray-800">{t('testimonials.title')}</h2>
          <p className="text-base md:text-xl text-gray-700 max-w-3xl mx-auto">
            {t('testimonials.subtitle')}
          </p>
        </div>
        
        <div className="flex justify-center items-center p-6 md:p-12 bg-white rounded-lg shadow-lg">
